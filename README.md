...
```python
python Filter_Full_GO_Datasets -i biomaRt_results.tsv -dl sorted_dataset_list.txt -rl refSeq_accessions_list.txt -o filtered_biomaRt_results.tsv #specify output
```
